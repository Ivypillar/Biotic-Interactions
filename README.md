...
Subtract a taxon string from a combined taxon and author string to create an author string.

awk -v FPAT='([^,]*)|("[^"]*")' 'NF{t=$10;gsub($9" ","",t);print$0","t}' glonaf_taxon_wcvp.csv > glonaf_taxon_wcvp_author.csv
